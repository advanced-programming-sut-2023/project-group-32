...
public class SignUpMenu {
    ...
    public static void run() throws InterruptedException, IOException, CloneNotSupportedException {
        String command;
        Matcher matcher;
        while (true){
    ...
    public static void login(String content) throws IOException, InterruptedException, CloneNotSupportedException {
