...
public class Test {
    ...
    public static final String TEXT_CYAN   = "\u001B[36m"; //firozeh
    public static final String TEXT_BRIGHT_BLACK  = "\u001B[90m"; //tusi
    public static final String TEXT_BRIGHT_WHITE  = "\u001B[97m"; //sefid
    ...
    public static final String WHITE = "\u001B[7m";
    ...
    public static void main(String[] args) {
        ...
        System.out.println(TEXT_BRIGHT_BLACK + "salam");
    }
    @org.junit.Test
    public void testLogin() throws IOException, InterruptedException, CloneNotSupportedException {
        String content = Menu.getScanner().nextLine();
        SignUpMenu.login(content);
    }
    @org.junit.Test
    public void testRegister() throws IOException, InterruptedException {
        String content = Menu.getScanner().nextLine();
        SignUpMenu.signUp(content);
    }
}
